sap.ui.define([
    ...
    return Controller.extend("fiori.template.controller.Worklist",{
        ...
        onClienteSelected : function(oEvent){

            //instancia da classe
            var oSelectedItem = oEvent.getSource();

            //modelo default no manifest, deixa sem nada
            var oContext = oSelectedItem.getBindingContext();

            //Caminho do serviço
            var sPath = oContext.getPath();

            var oPanel = this.byId("panelClientes");
